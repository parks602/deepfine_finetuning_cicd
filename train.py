...
data_dir  = "C:\deepfine_finetune\dataset"
train_dir  = data_dir+"\train"
test_dir  = data_dir+"\test"
model_dir = "C:\deepfine_finetune\models"
model_eval_file = "C:\deepfine_finetune\evaluator.csv"
def F_make_dir(Path):
...
for epoch in range(epoch_length):
    ...
    torch.save(best_model_wts, 'best_model_weights_%s.pth'%(current_time))
...
add_model_performance(best_model_wts, best_acc, model_eval_file)